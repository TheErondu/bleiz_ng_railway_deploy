        ...
        <div class="w-full max-w-5xl bg-white p-8 rounded-lg shadow">
            <form action="{{route('register')}}" method="POST" id="mainForm" novalidate>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900">Phone Number <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        <label for="employer" class="block mb-2 text-sm font-medium text-gray-900">Employer <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="employer_address" class="block mb-2 text-sm font-medium text-gray-900">Employer Address <span class="text-red-500">*</span></label>
                        <input type="text" id="employer_address" name="employer_address" value="{{ old('employer_address') }}" required
                    ...
                    <div>
                        <label for="employment_id" class="block mb-2 text-sm font-medium text-gray-900">Employment ID No <span class="text-red-500">*</span></label>
                        <input type="text" id="employment_id" name="employment_id" value="{{ old('employment_id') }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        <label for="bank" class="block mb-2 text-sm font-medium text-gray-900">Select Bank <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="account_name" class="block mb-2 text-sm font-medium text-gray-900">Account Name <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="account_no" class="block mb-2 text-sm font-medium text-gray-900">Account No. <span class="text-red-500">*</span></label>
                        <input type="text" id="account_no" name="account_no" value="{{ old('account_no') }}" required
